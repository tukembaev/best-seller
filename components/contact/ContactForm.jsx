...
---
Отправлено через форму контактов`;
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 bg-white">
      ...
      <button
        type="submit"
        className="w-full bg-green-500 text-white py-3 rounded-xl hover:bg-green-600 hover:scale-103 active:scale-95 transition font-semibold text-sm flex items-center justify-center gap-2"
      >
      ...
      <p className="text-xs text-slate-500 text-center">
        При нажатии кнопки откроется WhatsApp с готовым сообщением для номера +996 770 220 555
      </p>
    </form>
  );
}