    ...
    const linkSections = [
        {
            ...
            links: [
                { text: t('footer.earphones'), path: '/', icon: null },
                { text: t('footer.headphones'), path: '/', icon: null },
                { text: t('footer.smartphones'), path: '/', icon: null },
                { text: t('footer.laptops'), path: '/', icon: null },
            ]
        },
        {
            ...
            links: [
                ...
                { text: t('footer.privacy'), path: '/', icon: null },
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">{t('footer.description')}</p>
